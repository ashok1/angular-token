...
export declare class AngularTokenService implements CanActivate {
    ...
    constructor(http: HttpClient, window: any, config: any, platformId: Object, activatedRoute: ActivatedRoute, router: Router);
     ...
     */
    private getUserPath;
    private addTrailingSlashIfNeeded;
    private getApiPath;
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<AngularTokenService, [null, null, null, null, { optional: true; }, { optional: true; }]>;
    static ɵprov: i0.ɵɵInjectableDeclaration<AngularTokenService>;
}
